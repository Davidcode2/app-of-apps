...
├── umami
│   ├── docker-compose.yaml
│   ├── umami-db-data-persistentvolumeclaim.yaml
│   ├── umami-db-deployment.yaml
│   ├── umami-db-service.yaml
│   ├── umami-deployment.yaml
│   ├── umami-ingress-resource.yaml
│   ├── umami-namespace.yaml
│   └── umami-service.yaml
└── access-key
